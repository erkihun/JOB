    ...
    <tr>
        <td align="center">
            ...
            <table role="presentation" class="email-container" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                    <td align="center"
                        style="background: linear-gradient(135deg, {{ $brandColor }} 0%, color-mix(in srgb, {{ $brandColor }} 75%, #000) 100%);
                        ...
                        <p style="margin:6px 0 0; font-size:11px; font-weight:600; color:rgba(255,255,255,.65);
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td align="center"
                                                ...
                                                <!-- OTP digits -->
                                                <p class="otp-text"
                                                   style="margin:0; font-size:44px; font-weight:800;
                                                          color:{{ $brandColor }}; letter-spacing:14px;
                                                ...
                                                <!-- Expiry badge -->
                                                <p style="margin:14px 0 0; display:inline-block;
                ...
                <tr>
                    <td align="center" style="padding: 24px 44px 32px;">
                        <p style="margin:0; font-size:12px; color:#94a3b8; line-height:1.6;">
                            © {{ $year }} <strong style="color:#64748b;">{{ $orgName }}</strong>.
                            All rights reserved.
                        </p>
