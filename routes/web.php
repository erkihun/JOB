...
Route::get('/lang/{locale}', function (string $locale) {
    $available = (array) Setting::get('app.available_locales', config('app.available_locales', ['en', 'am']));
...
Route::redirect('/login', '/applicant/login')->name('login');
...
Route::middleware(['auth', 'applicant'])->prefix('applicant')->name('applicant.')->group(function () {
    ...
    Route::post('/applications/{application}/documents/{document}/replace', [ApplicationController::class, 'replaceDocument'])->name('applications.documents.replace');
